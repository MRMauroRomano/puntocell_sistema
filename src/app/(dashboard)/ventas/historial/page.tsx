...
export default function SalesHistoryPage() {
  ...
  const handleReturnSale = async (sale: Sale) => {
    ...
    try {
      ...
      toast({
        ...
        description: "El stock ha sido restaurado y la venta anulada.",
      })
    } catch (error) {
      toast({
        variant: "destructive",
  ...
  return (
    <div className="space-y-6">
                ...
                <TableBody>
                  {filteredSales.map((sale) => (
                    <TableRow key={sale.id} className="hover:bg-primary/5">
                      ...
                      <TableCell>
                        <div className="text-sm font-bold">{sale.customerName}</div>
                            ...
                            <AlertDialogContent>
                              <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                  Esta acción anulará la venta #{sale.id.slice(-6)}, devolverá el stock a los productos correspondientes y actualizará el saldo del cliente si fue a cuenta corriente.
                                </AlertDialogDescription>
                              </AlertDialogHeader>
                              <AlertDialogFooter>
      ...
      {/* DIÁLOGO DE FACTURA PARA REIMPRESIÓN */}
              ...
              <div id="invoice-print-area" className="w-[800px] mx-auto text-black p-8 border-[2px] border-black rounded-sm bg-white font-sans scale-90 origin-top">
                ...
                <div className="min-h-[400px]">
                  <table className="w-full text-xs">
                    ...
                    <tbody className="font-bold">
                      ...
                      {Array.from({ length: Math.max(0, 8 - selectedSale.items.length) }).map((_, i) => (
                ...
                <div className="border-t-[2px] border-black p-6 flex justify-between items-end bg-gray-50">
                  <div className="text-[10px] font-bold space-y-2">
                    <p className="uppercase text-gray-600">Observaciones: {selectedSale.paymentMethod === 'credit_account' ? 'VENTA A CUENTA CORRIENTE' : 'VENTA CONTADO'}</p>
                    <p className="italic">Comprobante reimpreso desde TechStore Manager Pro</p>
                  </div>
