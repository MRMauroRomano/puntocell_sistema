  ...
  return (
    <div className="relative">
      ...
      <Dialog open={isSuccessDialogOpen} onOpenChange={setIsSuccessDialogOpen}>
        <DialogContent className="sm:max-w-[425px] no-print" onInteractOutside={(e) => e.preventDefault()}>
          ...
          <div className="border-[2px] border-black p-4 space-y-0 text-[11px] leading-tight shadow-sm">
            ...
            <div className="grid grid-cols-11 border-b-[2px] border-black">
              <div className="col-span-5 p-2 space-y-1">
                ...
                <p className="font-bold text-xs uppercase">Venta de Celulares y Electrónica</p>
              ...
              <div className="col-span-5 p-2 space-y-2 text-right">
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="border-b-[2px] border-black text-[10px] font-black bg-gray-100">
                    ...
                    <th className="border-r-[2px] border-black p-2 text-left">DESCRIPCIÓN</th>
            ...
            <div className="mt-auto border-t-[2px] border-black">
              <div className="grid grid-cols-4 text-center font-black text-[10px] border-b-[2px] border-black uppercase bg-gray-100">
                ...
                <div className="border-r-[2px] border-black p-2">IVA 21%</div>
                <div className="border-r-[2px] border-black p-2">Exento</div>
                <div className="p-2 bg-black text-white">Total AR$</div>
              </div>
              ...
              <div className="flex justify-between items-center p-4">
                ...
                <div className="text-right">
                  <p className="text-[10px] font-black uppercase">CAE Nº: 34129987456321</p>
                  <p className="text-[8px] font-bold">Vto. CAE: {new Date().toLocaleDateString()}</p>
                </div>
              </div>
            </div>
          </div>
